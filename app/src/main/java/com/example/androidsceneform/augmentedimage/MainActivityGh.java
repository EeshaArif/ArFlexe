...
public class MainActivityGh extends AppCompatActivity {
    private static final String TAG = com.example.androidsceneform.augmentedimage.MainActivityGh.class.getSimpleName();
        ...
        for (AugmentedImage augmentedImage : updatedAugmentedImages) {
            if (augmentedImage.getTrackingState() == TrackingState.TRACKING) {
                ...
                if (augmentedImage.getName().equals("delorean")) {
                    AugmentedImageNode node = new AugmentedImageNode(this, "hheart.sfb");
