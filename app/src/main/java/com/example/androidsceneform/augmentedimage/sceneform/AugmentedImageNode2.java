...
public class AugmentedImageNode2 extends AnchorNode {
    ...
    public AugmentedImageNode2(Context context, String filename) {
    ...
    public void setImage(AugmentedImage image) {
        ...
        Pose pose = Pose.makeTranslation(0.0f, 0.25f, 0.0f);
