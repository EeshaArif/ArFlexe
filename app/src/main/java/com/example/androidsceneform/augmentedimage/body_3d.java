...
import com.example.androidsceneform.augmentedimage.sceneform.AugmentedImageNode1;
import com.example.androidsceneform.common.helpers.CameraPermissionHelper;
import com.example.androidsceneform.common.helpers.FullScreenHelper;
...
public class body_3d extends AppCompatActivity {
    private static final String TAG = com.example.androidsceneform.augmentedimage.body_3d.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_3d);
        ...
        for (AugmentedImage augmentedImage : updatedAugmentedImages) {
            if (augmentedImage.getTrackingState() == TrackingState.TRACKING) {
                ...
                if (augmentedImage.getName().equals("delorean")) {
                    ...
                    AugmentedImageNode1 node = new AugmentedImageNode1(this, "hheart.sfb");
